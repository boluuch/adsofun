...
const Header = ({ image, heading, description }) => {
  ...
  return (
    <header className={`bg-${image} text-white h-[100vh] px-[3rem] py-[1rem]`}>
      <nav className="flex justify-between bg-inherit items-center p-4">
        <Link to="/">
